...
try:
    ...
    # 且返回不再含 is_watch/is_buy_recommend——大盘禁买语义(is_watch=True)在
    # run_stock_screener 出口层面设置(buy_plan["is_watch"] = not can_buy)；
    # 函数内部仅经 market_info["position_limit_ratio"] 影响资金，禁买时该值=0
